...
admin_route.get('/edit-user', auth.isLogin, adminController.editUserLoad); // Load edit-user form
admin_route.post('/edit-user', upload.single('image'), adminController.updateUser); // Update user details
admin_route.get('/delete-user', auth.isLogin, adminController.deleteUser); // Delete user
